...
func (bq *BoardQuery) FirstID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (bq *BoardQuery) FirstIDX(ctx context.Context) uint {
...
func (bq *BoardQuery) OnlyID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (bq *BoardQuery) OnlyIDX(ctx context.Context) uint {
...
func (bq *BoardQuery) IDs(ctx context.Context) (ids []uint, err error) {
...
func (bq *BoardQuery) IDsX(ctx context.Context) []uint {
	ids, err := bq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (bq *BoardQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(board.Table, board.Columns, sqlgraph.NewFieldSpec(board.FieldID, field.TypeUint))
	_spec.From = bq.sql
